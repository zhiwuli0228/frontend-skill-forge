...
- **Coverage:** All 4 scenarios captured, all 3 sub-components discovered, 3 key interactions traced
...
- V3.4 will reference this index when documenting the V2.10 sidebar hotfix as a failure-diagnosis record.
- V4 (Skill v1) will use this evidence to train the `frontend-project-reader` skill to recognize the task list patterns.
